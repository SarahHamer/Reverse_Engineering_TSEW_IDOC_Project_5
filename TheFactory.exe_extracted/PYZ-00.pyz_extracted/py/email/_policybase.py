__doc__ = '''Policy framework for the email package.
...
class _PolicyBase:
  ...
  def __setattr__(self,name,value):
    msg = msg if hasattr(self,name) else '{!r} object attribute {!r} is read-only'
    ...
    if attr.__doc__ and attr.__doc__.startswith('+'):
      for c in (c for base in cls.__bases__ for c in base.mro()):
        ...
        if doc:
          ...
          _append_doc(cls.__bases__[0].__doc__,cls.__doc__)
          break
