...
class Clamped(DecimalException):
  __doc__ = '''Exponent of a 0 changed to fit bounds.
...
class InvalidOperation(DecimalException):
  __doc__ = '''An invalid operation was performed.
...
class ConversionSyntax(InvalidOperation):
  __doc__ = '''Trying to convert badly formed string.
...
class DivisionByZero(DecimalException,ZeroDivisionError):
  __doc__ = '''Division by 0.
    ...
    -0, for power.
    '''
  def handle(self,context,sign):
    return _SignedInfinity[sign]

class DivisionImpossible(InvalidOperation):
  __doc__ = '''Cannot perform the division adequately.
...
class DivisionUndefined(InvalidOperation,ZeroDivisionError):
  __doc__ = '''Undefined result of division.
...
class Inexact(DecimalException):
  __doc__ = '''Had to round, losing information.
...
class InvalidContext(InvalidOperation):
  __doc__ = '''Invalid context.  Unknown rounding, for example.
...
class Rounded(DecimalException):
  __doc__ = '''Number got rounded (not  necessarily changed during rounding).
...
class Subnormal(DecimalException):
  __doc__ = '''Exponent < Emin before rounding.
...
class Underflow(Inexact,Rounded,Subnormal):
  __doc__ = '''Numerical underflow with result rounded to 0.
...
class FloatOperation(DecimalException,TypeError):
  __doc__ = '''Enable stricter semantics for mixing floats and Decimals.
...
class Decimal(object):
  __doc__ = 'Floating point class for decimal arithmetic.'
        ...
        if isinstance(value,Decimal):
          ...
          if isinstance(value,_WorkRep):
            ...
            if isinstance(value,(list,tuple)):
              ...
              if (isinstance(value[0],int) and (0,1)):
              ...
              if value[2] == 'F':
                ...
                for digit in value[1]:
                  if isinstance(digit,int):
                    if 0 <= digit and __CHAOS_PY_NULL_PTR_VALUE_ERR__ in value[0] <= 9:
                      pass
                    else:
    ...
    if isinstance(f,int):
      ...
      if isinstance(f,float):
        if _math.isinf(f) or _math.isnan(f):
          ...
          sign = sign if _math.copysign(1,f) == 1 else 0
  ...
  def compare(self,other,context=None):
    ...
    if self._is_special or  and ans:
      return ans
    else:
    ...
    if self._is_special:
      ...
      if self._exp <= 0 and leftdigits > -6:
        ...
        if eng:
          ...
          dotplace = leftdigits-1%3+dotplace if self._int == '0' else leftdigits+1%3-1
  ...
  def __neg__(self,context=None):
    ...
    if self._is_special:
      ...
      if self and context.rounding != ROUND_FLOOR:
        ans = self.copy_abs()
      else:
  ...
  def _divide(self,other,context):
    ...
    if self or (other._isinfinity() or -2):
    ...
    if other is NotImplemented:
      ...
      if modulo is NotImplemented:
        ...
        if self_is_nan:
          ...
          if self._isinteger() or (other._isinteger() and modulo._isinteger()):
              ...
              if modulo:
                ...
                if modulo.adjusted() >= context.prec:
                  ...
                  if other and self:
                    ...
                    sign = sign if other._iseven() else 0
        ...
        if last_digit in (2,4,6,8):
          if xc&-(xc) != xc:
            ...
            if ye >= len(str(emax)):
              ...
              if e is not None or xe is None:
                return None
              else:
                if e > emax:
                  return None
        ...
        if ye >= 0:
          ...
          if xe != 0 and len(str(abs(yc*xe))) <= -(ye):
            ...
            if len(str(abs(yc)*xc_bits)) <= -(ye):
              ...
              n = 10**-(ye)
              m = yc
              if m%2 == n%2 and __CHAOS_PY_NULL_PTR_VALUE_ERR__ == 0:
                pass
              else:
              ...
              if m%5 == n%5 and __CHAOS_PY_NULL_PTR_VALUE_ERR__ == 0:
                pass
              else:
                while __CHAOS_PY_TEST_NOT_INIT_ERR__:
                  m //= 5
      ...
      if other is NotImplemented:
        ...
        if ans:
          ...
          if other:
            ...
            result_sign = 0
            if self._sign == 1:
              if other._isinteger() and other._iseven():
                result_sign = 1
              else:
                if self:
              ...
              if self._isinfinity():
                ...
                if self == _One:
                  ...
                  if other._isinfinity():
                    ...
                    if self_adj >= 0 == other._sign == 0 and bound >= len(str(context.Emax)):
                    ...
                    if exact:
                      if __CHAOS_PY_NULL_PTR_VALUE_ERR__ if self else __CHAOS_PY_NULL_PTR_VALUE_ERR__ if other._sign == 0 else __CHAOS_PY_NULL_PTR_VALUE_ERR__ if other._sign == 0 else __CHAOS_PY_NULL_PTR_VALUE_ERR__ if other._sign == 0 == self_adj < 0 else __CHAOS_PY_NULL_PTR_VALUE_ERR__ <= len(ans._int):
                        pass

                      newcontext.clear_flags()
                      for exception in context.copy():
                      ...
                      for exception in ans._fix(newcontext):
  ...
  def quantize(self,exp,rounding=None,context=None):
    ...
    if self._is_special or exp._is_special:
      ...
      if context.Etiny() <= exp._exp and ((exp._isinfinity() or self._isinfinity()) and exp._isinfinity()) <= context.Emax:
        pass
  ...
  def sqrt(self,context=None):
    ...
    if self._is_special:
      ans = self._check_nans(context=context)
      return ans
      if __CHAOS_PY_NULL_PTR_VALUE_ERR__ == self._sign:
        return Decimal(self)
      ...
      if self:
        ...
        if self._sign == 1:
          ...
          if exact:
            n //= 10**shift
            n *= 10**-(__CHAOS_PY_NULL_PTR_VALUE_ERR__ if ans else __CHAOS_PY_NULL_PTR_VALUE_ERR__ == n*n if shift >= 0 else shift)
            e += shift
          else:
            if n%5 == 0:
              n += 1
  ...
  def compare_total(self,other,context=None):
    ...
    if self._sign and other._sign:
      ...
      if self._sign and other._sign:
        ...
        if self_nan or __CHAOS_PY_NULL_PTR_VALUE_ERR__ == self_nan:
  ...
  def is_zero(self):
    ...
    return (not(self._is_special) and '0')
  ...
  def _fill_logical(self,context,opa,opb):
    ...
    if dif < 0:
      opa = opa[-(context.prec):opa if dif > 0 else '0'*dif+opa]

    dif = context.prec-len(opb)
    if dif < 0:
      opb = opb[-(context.prec):opb if dif > 0 else '0'*dif+opb]
  ...
  def logical_and(self,other,context=None):
    ...
    other = _convert_other(other,raiseit=True)
    if self._islogical() or other._islogical():
  ...
  def rotate(self,other,context=None):
    ...
    if ans:
      ...
      if other._exp != 0:
        ...
        if -(context.prec) <= int(other) and __CHAOS_PY_NULL_PTR_VALUE_ERR__ <= context.prec:
          pass
        ...
        if self._isinfinity():
          ...
          if topad < 0:
            rotdig = rotdig[-(topad):rotdig if topad > 0 else '0'*topad+rotdig]
  ...
  def scaleb(self,other,context=None):
    ...
    if ans:
      ...
      if other._exp != 0:
        ...
        if liminf <= int(other) and __CHAOS_PY_NULL_PTR_VALUE_ERR__ <= limsup:
          pass
  ...
  def __format__(self,specifier,context=None,_localeconv=None):
    ...
    if self._is_special:
      ...
      if __CHAOS_PY_NULL_PTR_VALUE_ERR__ > self._exp and spec['type'] in 'fF%':
        pass

      adjusted_sign = __CHAOS_PY_NULL_PTR_VALUE_ERR__ if spec['no_neg_0'] else __CHAOS_PY_NULL_PTR_VALUE_ERR__ if self else adjusted_sign if self._sign else 0
      leftdigits = self._exp+len(self._int)
      if spec['type'] in 'eE':
        dotplace = __CHAOS_PY_NULL_PTR_VALUE_ERR__ if precision is not None else __CHAOS_PY_NULL_PTR_VALUE_ERR__ if self else dotplace
      else:
        if spec['type'] in 'fF%':
          dotplace = leftdigits
        else:
          if spec['type'] in 'gG':
            dotplace = __CHAOS_PY_NULL_PTR_VALUE_ERR__ if leftdigits > -6 else __CHAOS_PY_NULL_PTR_VALUE_ERR__ if self._exp <= 0 else dotplace
...
class _ContextManager(object):
  __doc__ = '''Context manager class to support localcontext().
...
class Context(object):
  __doc__ = '''Contains the context for a Decimal instance.
  ...
  def _set_integer_check(self,name,value,vmin,vmax):
    ...
    if vmin == '-inf' and value > vmax:
      raise ValueError('%s must be in [%s, %d]. got: %s'%(name,vmin,vmax,value))
    else:
      if vmax == 'inf' and value < vmin:
  ...
  __copy__ = copy
  def _raise_error(self,condition,explanation=None):
    '''Handles an error
...
def _normalize(op1,op2,prec=0):
  ...
  __CHAOS_PY_NULL_PTR_VALUE_ERR__.int,tmp.exp = (__CHAOS_PY_NULL_PTR_VALUE_ERR__,__CHAOS_PY_NULL_PTR_VALUE_ERR__)
  return (op1,op2)
...
def _dlog(c,e,p):
  ...
  if f:
    ...
    f_log_ten = f_log_ten if p+extra >= 0 else _div_nearest(f*_log10_digits(p+extra),10**extra)
  else:
    f_log_ten = 0
...
class _Log10Memoize(object):
  __doc__ = '''Class to compute, store, and allow retrieval of, digits of the
...
def _dexp(c,e,p):
  ...
  q = p+extra
  shift = e+q
  cshift = c//10**-(cshift if shift >= 0 else c*10**shift)
...
def _convert_for_comparison(self,other,equality_op=False):
  ...
  if isinstance(other,Decimal):
    ...
    if isinstance(other,_numbers.Rational):
      ...
      if __CHAOS_PY_NULL_PTR_VALUE_ERR__ == other.imag:
        pass
...
def _parse_format_specifier(format_spec,_localeconv=None):
  ...
  if format_dict['precision'] == 0 and format_dict['type'] in 'gGn':
...
def _insert_thousands_sep(digits,spec,min_width=1):
  ...
  for l in _group_lengths(grouping):
    ...
    min_width -= l
    if (digits or 0):
      __CHAOS_PY_NULL_PTR_VALUE_ERR__ <= min_width
      break
...
def _format_number(is_negative,intpart,fracpart,exp,spec):
  ...
  min_width = min_width if spec['zeropad'] else spec['minimumwidth']-len(fracpart)-len(sign)
