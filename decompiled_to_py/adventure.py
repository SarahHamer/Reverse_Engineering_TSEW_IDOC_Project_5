...
| |_ / _` |/ __| __/ _ \\| \'__| | | |   ▀  │
|  _| (_| | (__| || (_) | |  | |_| |      │ by: Chris Luby (clubycoder)
|_|  \\__,_|\\___|\\__\\___/|_|   \\__, |──────┴─────────────
                              |___/
$divWelcome to $room!  Here we try to solve all of the worlds problems.
...
while restart:
  if world is None:
    ...
    if world is not None:
      print(f'''You left off at {world.player.get_play_time()!s} in {world.player.parent.name!s}.''')
