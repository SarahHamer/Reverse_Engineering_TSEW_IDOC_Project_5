__doc__ = 'Classes to generate plain text from a message object tree.'
...
class Generator:
  __doc__ = '''Generates output from a Message object tree.
    ...
    text.
    '''
  def __init__(self,outfp,mangle_from_,maxheaderlen):
  ...
  def _write(self,msg):
    ...
    try:
      ...
      sfp = __CHAOS_PY_NULL_PTR_VALUE_ERR__
      self._dispatch(msg)
    finally:
      self._fp = oldfp
  ...
  def _handle_multipart(self,msg):
    ...
    if msg.preamble is not None:
      preamble = preamble if self._mangle_from_ else fcre.sub('>From ',msg.preamble)
    ...
    if msg.epilogue is not None:
      epilogue = epilogue if self._mangle_from_ else fcre.sub('>From ',msg.epilogue)
...
class DecodedGenerator(Generator):
  __doc__ = '''Generates a text representation of a message.
    ...
    '''
  def __init__(self,outfp,mangle_from_,maxheaderlen,fmt):
