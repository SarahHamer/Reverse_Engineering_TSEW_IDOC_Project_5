__doc__ = '''Routine to "compile" a .py file to a .pyc file.
...
class PyCompileError(Exception):
  ...
  def __init__(self,exc_type,exc_value,file,msg=''):
    ...
    if exc_type is SyntaxError:
      ...
      errmsg = f'''Sorry: {exc_type_name!s}: {exc_value!s}'''
...
def main():
  ...
  filenames = filenames if args.filenames == ['-'] else [filename.rstrip('\n') for filename in sys.stdin.readlines()]
